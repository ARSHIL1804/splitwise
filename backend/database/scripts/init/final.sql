...
INSERT INTO `EnumCurrency` VALUES (1,'INR','₹'),(2,'USD','$');
...
CREATE TABLE `User` (
  ...
  KEY `user_currency_idx` (`currency`),
  CONSTRAINT `user_currency` FOREIGN KEY (`currency`) REFERENCES `EnumCurrency` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
ALTER DATABASE `splitwise` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ;
...
-- Dump completed on 2025-04-19 15:47:04
